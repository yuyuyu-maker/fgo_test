#!/usr/bin/env bash
# Go2 full round: teacher-KD reflow + reward_aware + adaptive_compute + theory.
...
export TMPDIR="${TMPDIR:-/dev/shm/_go2_all_ideas_teacher_kd_tmp}"
...
WS_LOG_DIR="${ROOT}/logs/isaaclab_fpo/go2_all_ideas_teacher_kd_${MAX_ITERS}"
