#!/usr/bin/env bash
# Matched Go2 baseline: 4096 envs, 500 iters, then 64/1 x zero/random eval.
# Usage: GPU=2 bash scripts/run_go2_baseline_500.sh
set -eo pipefail
...
export TMPDIR="${TMPDIR:-/dev/shm/_go2_baseline_tmp}"
...
WORKDIR="/dev/shm/go2_baseline_500"
WS_LOG_DIR="${ROOT}/logs/isaaclab_fpo/go2_baseline_500"
