...
# Official G1-29dof USD lives here (huggingface unitreerobotics/unitree_model).
# Override with env UNITREE_MODEL_DIR. Isaac Lab nucleus G1.usd is a different
# joint set (fingers / torso_joint) and cannot replace g1_29dof_rev_1_0.
_UNITREE_MODEL_CANDIDATES = [
    os.environ.get("UNITREE_MODEL_DIR", ""),
    "/dev/shm/unitree_model",
    "/workspace/fgo_test/unitree_model",
]
UNITREE_MODEL_DIR = "path/to/unitree_model"
for _cand in _UNITREE_MODEL_CANDIDATES:
    if _cand and os.path.isdir(_cand):
        UNITREE_MODEL_DIR = _cand
        break
UNITREE_ROS_DIR = os.environ.get("UNITREE_ROS_DIR", "path/to/unitree_ros")
# This workspace uses Isaac Lab 2.1 + Isaac Sim 4.5; Nucleus Go2 USD matches Isaac Lab's UNITREE_GO2_CFG.
